    ...
    <div>
        ...
        <table class="my_table table2" border>
            ...
            <tbody>
                <tr>
                    <th>
                        <h3>--gettersの戻り値[$store.getters["numberStore/getSampleNumber"]]--</h3>
                    </th>
                    <td>
        ...
        <table class="my_table table3" border>
            ...
            <tbody>
                <tr>
                    <th>
                        <h3>--gettersの戻り値[this.$store.getters["stringStore/getSampleString"]]--</h3>
                    </th>
                    <td>
        ...
        <table class="my_table table4" border>
            ...
            <tbody>
                <tr>
                    <th>
                        <h3>--gettersの戻り値this.$store.getters["arrayStore/getSampleArray"]--</h3>
                    </th>
                    <td>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" v-model="sampleArrayElem"/><input type="button" @click="push2Array()" value="push"/>
                    </td>
                </tr>
            </tbody>
        </table>
